...
metaDescription: >-
  Rénovation énergétique dans l'ancien : la présence d'amiante est un risque
  sanitaire souvent sous-estimé. Le repérage avant travaux (RAAT) sécurise le
  chantier.
anciennesUrls:
  - >-
    /amiante-et-renovation-energetiquen-attention-aux-risques-dans-les-batiments-anciens-a104.html
extrait: >-
  Isoler ou rénover un bâtiment ancien peut exposer à l'amiante. Le repérage
  avant travaux (RAAT) est une étape obligatoire pour sécuriser votre
  chantier.
archive: false
---
